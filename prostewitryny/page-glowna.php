    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col banner-col">
                <h1><strong>Firmowe&nbsp;strony&nbsp;internetowe</strong><br>Zaistniej&nbsp;w&nbsp;sieci i&nbsp;niech&nbsp;czas zrobi&nbsp;swoje!</h1>
...
<section id="baner-answer">
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                <h2>Tworzymy strony WWW i zajmujemy się nimi!</h2>
            </div>
        </div>
    </div>
</section>
